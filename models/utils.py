...
def get_timestep_embedding(timesteps, embedding_dim: int, const:int = 10000):
    """
...
class TimeStep2Sinusoid:
    def __init__(self, embedding_dim: int, const: int = 10000):
